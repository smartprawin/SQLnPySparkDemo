...
(function () {
  ...
  var TOPICS = [
    ...
    { id: 'exercises-intro', title: 'SQL Practice Exercises - 40 Hands-On Problems', url: 'exercises.html#exercises-intro', tags: 'exercises intro sql practice 40 hands on problems' },
    ...
    { id: 'what-is-database', title: 'What is a Database?', url: 'fundamentals.html#what-is-database', tags: 'database organized collection employees departments' },
    ...
    { id: 'framework', title: 'SQL Problem-Solving Framework', url: 'interview.html#framework', tags: 'framework output tables join filter' },
    ...
    { id: 'employee-more-than-manager', title: 'Employee Earning More Than Manager', url: 'joins.html#employee-more-than-manager', tags: 'employee more than manager earning joins' },
    ...
    { id: '1nf', title: 'First Normal Form - 1NF', url: 'modeling.html#1nf', tags: '1nf atomic courses' },
    { id: '2nf', title: 'Second Normal Form - 2NF', url: 'modeling.html#2nf', tags: '2nf partial dependency composite' },
    { id: '3nf', title: 'Third Normal Form - 3NF', url: 'modeling.html#3nf', tags: '3nf transitive dependency department' },
    ...
    { id: 'star-vs-snowflake', title: 'Star vs Snowflake', url: 'modeling.html#star-vs-snowflake', tags: 'star vs snowflake modeling' },
    ...
    { id: 'cte', title: 'CTE (Common Table Expression)', url: 'subqueries.html#cte', tags: 'cte with high salary' },
    { id: 'window-intro', title: 'Window Functions', url: 'window.html#window-intro', tags: 'window functions without collapsing' },
    ...
    { id: 'previous-transaction', title: 'Previous Transaction', url: 'window.html#previous-transaction', tags: 'previous transaction window' },
    { id: 'next-transaction', title: 'Next Transaction', url: 'window.html#next-transaction', tags: 'next transaction window' },
    { id: 'running-total', title: 'Running Total', url: 'window.html#running-total', tags: 'running total sum partition order' },
    { id: 'dept-avg', title: 'Employees Above Department Average', url: 'window.html#dept-avg', tags: 'dept avg employees above department average window' },
  ];
